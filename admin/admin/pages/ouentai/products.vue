  ...
  <div>
    ...
    <div page-content>
      ...
      <div main-content >
        ...
        <h2 content-header>応援隊販売商品一覧</h2>

        <div ouentai-products>

          <ProductCard v-for="(item , index) in products" :item="item" :index="index" @submitParent="openEditBox(index)"/>
  ...
  <el-dialog title="商品編集" :visible.sync="editProductBox" add-product-dialog >
    <div add-box>
      ...
      <div add-box-right>
        ...
        <div input-set>
          <label switch-set><span>税込販売価格</span></label>
...
export default {
  ...
  computed: {
      ...
      ...mapGetters( 'ouentaiProducts' , ['products']),
  },
  methods:{
      ...mapActions( 'user' , ['setProfile','setLogin']),
      ...mapActions( 'ouentaiProducts' , ['setProducts']),
      ...
      loadProducts : async function(){
        ...
        await axios.post( process.env.API_URL + 'getOuentaiProducts' , {
          token: process.env.OUENTAI_TOKEN,
        })
          .then( function(result){

            this.setProducts(result.data.ouentaiProducts)
      ...
      ******************************************************************/
      ...
      sendApiToNewProduct : function(){
        ...
        if(flg){
          ...
          axios.post( process.env.API_URL + 'addOuentaiProduct' , {
            token: process.env.OUENTAI_TOKEN,
            new_ouentai_product: this.newProduct,
          } )
            .then( function(result){

              console.dir(result.data.ouentaiProducts)
      ...
      openEditBox : function(index){
        ...
        this.editProduct = JSON.parse( JSON.stringify( this.products[index] ) )
            ...
            if( this.editProduct.start != null && this.editProduct.start != '0000-00-00 00:00:00' ){
            ...
            if( this.editProduct.end != null && this.editProduct.end != '0000-00-00 00:00:00' ){
      ...
      submitEditProduct : function(){
        ...
        if(flg){
          ...
          params.append( 'token'    , process.env.OUENTAI_TOKEN )
          params.append( 'product'  , JSON.stringify( this.editProduct ) )

          let editProductId = this.editProduct.productId
          delete this.editProduct.productId
          axios.post( process.env.API_URL + 'updateOuentaiProduct' , {
            token: process.env.OUENTAI_TOKEN,
            ouentai_product_id: editProductId,
            set_ouentai_product: this.editProduct,
          } )
            .then( function(result){
