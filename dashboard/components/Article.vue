<template>
     <div article-box>
        ...
        <div article-publish>{{days(article.publish_date)}}</div>
        ...
        <div article-browsing>{{article.browsing|number_format}}</div>
        
        <div article-delete>
            <el-button type="danger" icon="el-icon-delete" size="mini" circle @click="deleteArticle"></el-button>
        </div>
        
        <div article-deliveries>{{article.deliveries|number_format}}</div>
        ...
        <el-dialog
          ...
          big-dialog>
            ...
            <div pt-2>
                <ArticleEditBox :article="article"/>
            </div>
    ...
    methods:{
        ...
        *******************************************/
        updateStatus : function(){
            ...
            axios.post( process.env.MEDIA + 'changeStatus' , db ).then( function(result){
        ...
        *******************************************/
        deleteFunction : async function(){
            ...
            var db = new URLSearchParams()
            db.append( 'article_id' , this.article.article_id )
            return await axios.post( process.env.MEDIA + 'articleDelete' , db ).then( function(result){
        ...
        *******************************************/
        sendMessageToLine : async function(){
            ...
            await this.sendAction( messages )
        ...
        createMessage : function(){
            ...
            var flex = {
              ...
              "hero": {
                ...
                "action": {
                  "type": "uri",
                  "uri": "https://liff.line.me/" + this.article.app_config.liff_id + "?app=" + this.article.app_config.app_code + "&article=" + this.article.article_id
                }
              },
              "body": {
                "type": "box",
        ...
        *******************************************/
        sendAction : function( messages ){
            ...
            var db = new URLSearchParams()
            db.append( 'article' , JSON.stringify( this.article ) )
            db.append( 'messages' , JSON.stringify( messages ) )
            axios.post( process.env.MEDIA + 'sendLine' , db ).then( function(result){
        ...
        *******************************************/
        getArticleSectionsById : async function(){
            ...
            var db = new URLSearchParams()
            db.append( 'article_id' , this.article.article_id )
            return await axios.post( process.env.MEDIA + 'getArticleSectionsById' , db ).then( function(result){
