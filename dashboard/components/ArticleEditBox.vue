     ...
     <div article-editbox>
        ...
        <div article-preview>
            ...
            <div preview-box>
                ...
                <div style="text-align:right;padding:0.5em;font-size:12px;">
    ...
    methods:{
        ...
        **************************************************/
        ...
        updateExistingArticle : function(){
            ...
            axios.post( process.env.MEDIA + 'updateArticle' , db ).then( function(result){
        ...
        addNewArticle : function(){
            ...
            var db = new URLSearchParams()
            db.append( 'article' , JSON.stringify( article ) )
            axios.post( process.env.MEDIA + 'addNewArticle' , db ).then( function(result){
...
[article-editbox] > *[article-edit]{border-right:1px solid #ccc;width:40%;overflow-y: scroll;}
[article-editbox] > *[article-sort]{border-right:1px solid #ccc;width:27%;overflow-y: scroll;}
[article-editbox] > *[article-preview]{width:33%;overflow-y: scroll;}
...
[preview-content] [content-text]{padding:0.5em;font-size:14px;text-align:justify;}
