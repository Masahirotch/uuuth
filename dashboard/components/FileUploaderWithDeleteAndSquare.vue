          ...
          <label center>
            <input 
              ...
              <div file-confirm center>
                  <nuxt-img :src="src" sizes="sm:200px" img-square/>
              </div>
          </label>

          <label file-delete center v-if="isCurrent || isFile">
...
export default {
    ...
    computed: {
      ...
      isCurrent : function(){
        ...
        return ( this.currentImage != '' && this.currentImage != null )? true:false
    ...
    methods:{
        ...
        *************************************************************************/
        ...
        sendImageToDB : function(){
            ...
            axios.post( process.env.API_API + 'apiSaveImage' , db ).then( function(result){
                ...
                parentSend.thumb = this.thumbnail
        ...
        *********************************************************/
        ...
        // ファイル取り消し
        fileDelete : function(deleteIndex){
            ...
            this.$emit( 'currentDelete' , deleteIndex )
            this.$emit( 'fileDelete' , deleteIndex )
            return
