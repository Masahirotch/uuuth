...
export default {
  ...
  methods:{
      ...
      chengeSale : function(index){
          ...
          params.append( 'action'   , 'chengeProductStatus' )
          params.append( 'token'    , process.env.OUENTAI_TOKEN )
          params.append( 'product'  , JSON.stringify( this.products[index] ) )
          params.append( 'target'   , 'isOnSale' )
          params.append( 'value'    , this.product.isOnSale )
