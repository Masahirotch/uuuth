        ...
        ******************************************************************/
        ...
        imageSetting : async function(){
            ...
            axios.post( process.env.API_URL , params )
                .then( function(result){
                  ...
                  this.newProduct.productPhoto = result.data.main
                  this.editProduct.productPhoto = result.data.main
        ...
        sendApiToNewProduct : function(){
            ...
            if(flg){
              ...
              var params = new FormData()
              params.append( 'action'   , 'addNewProducts' )
              params.append( 'token'    , process.env.INFO_TOKEN )
              params.append( 'product'  , JSON.stringify( this.newProduct ) )
...
@media(max-width: 1180px){
  [info-products] > *{width: 30%;max-width: 30%;min-height: 200px;}
}
[info-products] > *:hover{
...
[dialog-btn-area] .el-button.el-button--primary span{color:#FFF;}
</style>
